...
document.addEventListener('DOMContentLoaded', function () {
    ...
    (function () {
        ...
        if (ctx) {
            ...
            // Function to make an API request and create/update the chart
            function createOrUpdateChartWithAPI() {
                ...
                fetch('http://localhost:8000/images')
                    ...
                    .then(apiData => {
                        ...
                        const data = apiData.map(item => item.id);

                        // Check if the chart has been created or not
                        if (myChart) {
                            ...
                            myChart = new Chart(myCanvas, {
                                type: 'line',  // Change the chart type to horizontalBar
                                data: {
                                    labels: timestamps,
                                    datasets: [{
                                        label: 'Last 6 months',
                                ...
                                options: {
                                    ...
                                    plugins: {
                                        ...
                                        title: {
                                            display: true,
                                            text: ['Capture statistics', 'Nov - July'],
                                            align: 'start',
                                            color: '#171717',
                                            font: {
                                                size: 16
